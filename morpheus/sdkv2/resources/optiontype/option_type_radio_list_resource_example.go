...
func RenderOptionTypeRadioListConfig(t *testing.T, overrides map[string]string) (string, error) {
	t.Helper()
	...
	defaults := map[string]string{
		...
		"Editable":              "true",
		"ExportMeta":            "true",
		"FieldLabel":            "Radio Example",
		"FieldName":             "radioExample",
		"HelpBlock":             "Terraform radio list option type example",
	...
	templatePath := filepath.Join(dir, "option_type_radio_list_resource.tf.tmpl")
