...
func TestAccMorpheusFormKeyValueOk(t *testing.T) {
	t.Parallel()
	...
	resourceConfig, err := form.RenderKeyValueConfig(t, map[string]string{
		"Name":           name,
		"Code":           code,
		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeAggregateTestCheckFunc(
					...
					resource.TestCheckResourceAttr("hpe_morpheus_form.example", "option_type.0.type", "keyValue"),
					resource.TestCheckResourceAttr("hpe_morpheus_form.example", "option_type.0.code", optTypeCode),
					resource.TestCheckResourceAttr("hpe_morpheus_form.example", "option_type.0.convert_to_object", "true"),
					resource.TestCheckResourceAttr("hpe_morpheus_form.example", "option_type.0.key_placeholder", "Key123"),
					resource.TestCheckResourceAttr("hpe_morpheus_form.example", "option_type.0.value_placeholder", "Value123"),
					resource.TestCheckResourceAttr(
						"hpe_morpheus_form.example",
						"option_type.0.description",
						"Terraform keyValue example",
					),
					resource.TestCheckResourceAttr(
						"hpe_morpheus_form.example",
					...
					resource.TestCheckResourceAttr("hpe_morpheus_form.example", "option_type.0.field_label", "KeyValue"),
					resource.TestCheckResourceAttr("hpe_morpheus_form.example", "option_type.0.field_name", "keyValue"),
					resource.TestCheckResourceAttr(
						"hpe_morpheus_form.example",
