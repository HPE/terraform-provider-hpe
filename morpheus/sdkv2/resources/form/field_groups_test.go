		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeAggregateTestCheckFunc(
					...
					resource.TestCheckResourceAttr(
						"hpe_morpheus_form.example",
						"field_group.0.option_type.0.field_label",
						"Testing 1",
					),
					resource.TestCheckResourceAttr("hpe_morpheus_form.example", "field_group.0.option_type.0.field_name", "test1"),
					resource.TestCheckResourceAttr(
						"hpe_morpheus_form.example",
					...
					resource.TestCheckResourceAttr(
						"hpe_morpheus_form.example",
						"field_group.1.option_type.0.field_label",
						"Testing 2",
					),
