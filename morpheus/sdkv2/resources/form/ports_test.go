...
func TestAccMorpheusFormPortsOk(t *testing.T) {
	...
	resourceConfig, err := form.RenderPortsConfig(t, map[string]string{
		"Name":           name,
		"Code":           code,
		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeAggregateTestCheckFunc(
					...
					resource.TestCheckResourceAttr("hpe_morpheus_form.example", "option_type.0.type", "ports"),
					resource.TestCheckResourceAttr("hpe_morpheus_form.example", "option_type.0.code", optTypeCode),
					resource.TestCheckResourceAttr("hpe_morpheus_form.example", "option_type.0.cloud_field", "myCloud"),
					resource.TestCheckResourceAttr(
						"hpe_morpheus_form.example",
						"option_type.0.description",
						"Terraform ports example",
					),
					resource.TestCheckResourceAttr(
						"hpe_morpheus_form.example",
					...
					resource.TestCheckResourceAttr("hpe_morpheus_form.example", "option_type.0.field_label", "Exposed Ports"),
					resource.TestCheckResourceAttr("hpe_morpheus_form.example", "option_type.0.field_name", "ports"),
					resource.TestCheckResourceAttr("hpe_morpheus_form.example", "option_type.0.group_field", "myGroup"),
					resource.TestCheckResourceAttr(
						"hpe_morpheus_form.example",
					...
					resource.TestCheckResourceAttr("hpe_morpheus_form.example", "option_type.0.layout_field", "myLayout"),
