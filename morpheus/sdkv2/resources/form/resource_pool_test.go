...
func TestAccMorpheusFormResourcePoolOk(t *testing.T) {
	t.Parallel()
	...
	resourceConfig, err := form.RenderResourcePoolConfig(t, map[string]string{
		"Name":           name,
		"Code":           code,
		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeAggregateTestCheckFunc(
					...
					resource.TestCheckResourceAttr("hpe_morpheus_form.example", "option_type.0.type", "resourcePool"),
					...
					resource.TestCheckResourceAttr(
						...
						"Terraform resourcePool example",
					),
					resource.TestCheckResourceAttr(
						"hpe_morpheus_form.example",
					...
					resource.TestCheckResourceAttr("hpe_morpheus_form.example", "option_type.0.field_label", "Resource Pool"),
					resource.TestCheckResourceAttr("hpe_morpheus_form.example", "option_type.0.field_name", "resourcePool"),
					resource.TestCheckResourceAttr(
						"hpe_morpheus_form.example",
