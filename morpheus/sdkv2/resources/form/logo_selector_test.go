...
func TestAccMorpheusFormLogoSelectorOk(t *testing.T) {
	t.Parallel()
	...
	resourceConfig, err := form.RenderLogoSelectorConfig(t, map[string]string{
		"Name":           name,
		"Code":           code,
		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeAggregateTestCheckFunc(
					...
					resource.TestCheckResourceAttr(
						...
						"Terraform logo selector example",
					),
					resource.TestCheckResourceAttr(
						"hpe_morpheus_form.example",
