...
func RenderFormConfig(t *testing.T, overrides map[string]string) (string, error) {
	...
	defaults := map[string]string{
		...
		"OptionType3HelpBlock":                       "Help block example",
		...
		"OptionType4HelpBlock":                       "Help block example",
		...
		"OptionType5HelpBlock":                       "Help block example",
		...
		"OptionType6HelpBlock":                       "Help block example",
