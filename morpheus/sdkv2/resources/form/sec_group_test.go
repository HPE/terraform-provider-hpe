...
func TestAccMorpheusFormSecGroupOk(t *testing.T) {
	...
	resourceConfig, err := form.RenderSecGroupConfig(t, map[string]string{
		"Name":           name,
		"Code":           code,
		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeAggregateTestCheckFunc(
					...
					resource.TestCheckResourceAttr("hpe_morpheus_form.example", "option_type.0.type", "secGroup"),
					...
					resource.TestCheckResourceAttr("hpe_morpheus_form.example", "option_type.0.field_label", "Security Groups"),
					resource.TestCheckResourceAttr("hpe_morpheus_form.example", "option_type.0.field_name", "securityGroups"),
					resource.TestCheckResourceAttr(
						"hpe_morpheus_form.example",
