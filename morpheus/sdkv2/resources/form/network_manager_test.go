...
func TestAccMorpheusFormNetworkManagerOk(t *testing.T) {
	...
	resourceConfig, err := form.RenderNetworkManagerConfig(t, map[string]string{
		"Name":           name,
		"Code":           code,
		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeAggregateTestCheckFunc(
					...
					resource.TestCheckResourceAttr("hpe_morpheus_form.example", "option_type.0.type", "networkManager"),
					...
					resource.TestCheckResourceAttr("hpe_morpheus_form.example", "option_type.0.enable_ip_mode_selection", "true"),
					...
					resource.TestCheckResourceAttr("hpe_morpheus_form.example", "option_type.0.field_label", "network input"),
					resource.TestCheckResourceAttr("hpe_morpheus_form.example", "option_type.0.field_name", "networkInput"),
					...
					resource.TestCheckResourceAttr("hpe_morpheus_form.example", "option_type.0.help_block", "Select a network"),
					...
					resource.TestCheckResourceAttr("hpe_morpheus_form.example", "option_type.0.placeholder", "Select network"),
					...
					resource.TestCheckResourceAttr("hpe_morpheus_form.example", "option_type.0.show_network_type_selection", "true"),
				),
			},
			{
				Config:             providerConfig + resourceConfig,
