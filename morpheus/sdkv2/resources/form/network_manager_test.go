...
func TestAccMorpheusFormNetworkManagerOk(t *testing.T) {
	t.Parallel()
	...
	resourceConfig, err := form.RenderNetworkManagerConfig(t, map[string]string{"Name": name})
	if err != nil {
		t.Fatal(err)
	}
		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeAggregateTestCheckFunc(
					...
					resource.TestCheckResourceAttr("hpe_morpheus_form.example", "option_type1_type", "networkManager"),
					resource.TestCheckResourceAttr("hpe_morpheus_form.example", "option_type1_code", "network-manager-input"),
					...
					resource.TestCheckResourceAttr("hpe_morpheus_form.example", "option_type1_description", "Terraform network manager example"),
					resource.TestCheckResourceAttr("hpe_morpheus_form.example", "option_type1_display_value_on_details", "true"),
					resource.TestCheckResourceAttr("hpe_morpheus_form.example", "option_type1_enable_ip_mode_selection", "true"),
					...
					resource.TestCheckResourceAttr("hpe_morpheus_form.example", "option_type1_field_label", "network input"),
					resource.TestCheckResourceAttr("hpe_morpheus_form.example", "option_type1_field_name", "networkInput"),
					...
					resource.TestCheckResourceAttr("hpe_morpheus_form.example", "option_type1_help_block", "Select a network"),
					...
					resource.TestCheckResourceAttr("hpe_morpheus_form.example", "option_type1_name", "tf network manager example"),
					resource.TestCheckResourceAttr("hpe_morpheus_form.example", "option_type1_placeholder", "Select network"),
					...
					resource.TestCheckResourceAttr("hpe_morpheus_form.example", "option_type1_show_network_type_selection", "true"),
				),
			},
			{
				Config:             providerConfig + resourceConfig,
