...
func TestAccMorpheusFormTextOk(t *testing.T) {
	t.Parallel()
	...
	resourceConfig, err := form.RenderTextConfig(t, map[string]string{"Name": name})
	if err != nil {
		t.Fatal(err)
	}
		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeAggregateTestCheckFunc(
					...
					resource.TestCheckResourceAttr("hpe_morpheus_form.example", "option_type1_type", "text"),
					resource.TestCheckResourceAttr("hpe_morpheus_form.example", "option_type1_code", "test-input"),
					resource.TestCheckResourceAttr("hpe_morpheus_form.example", "option_type1_default_value", "Demo123"),
					resource.TestCheckResourceAttr("hpe_morpheus_form.example", "option_type1_description", "Terraform text example"),
					...
					resource.TestCheckResourceAttr("hpe_morpheus_form.example", "option_type1_field_label", "Testin"),
					resource.TestCheckResourceAttr("hpe_morpheus_form.example", "option_type1_field_name", "test"),
					...
					resource.TestCheckResourceAttr("hpe_morpheus_form.example", "option_type1_name", "tf text example"),
