...
func TestAccMorpheusFormFileContentOk(t *testing.T) {
	t.Parallel()
	...
	resourceConfig, err := form.RenderFileContentConfig(t, map[string]string{
		"Name":           name,
		"Code":           code,
		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeAggregateTestCheckFunc(
					...
					resource.TestCheckResourceAttr("hpe_morpheus_form.example", "option_type.0.type", "fileContent"),
					...
					resource.TestCheckResourceAttr("hpe_morpheus_form.example", "option_type.0.field_label", "FileContent"),
					resource.TestCheckResourceAttr("hpe_morpheus_form.example", "option_type.0.field_name", "fileContent"),
					resource.TestCheckResourceAttr(
						"hpe_morpheus_form.example",
					...
					resource.TestCheckResourceAttr("hpe_morpheus_form.example", "option_type.0.placeholder", "testing123"),
