...
func TestAccMorpheusFormServersInputOk(t *testing.T) {
	t.Parallel()
	...
	resourceConfig, err := form.RenderServersInputConfig(t, map[string]string{
		"Name":           name,
		"Code":           code,
		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeAggregateTestCheckFunc(
					...
					resource.TestCheckResourceAttr("hpe_morpheus_form.example", "option_type.0.type", "servers-input"),
					...
					resource.TestCheckResourceAttr(
						...
						"Terraform servers-input example",
					),
					resource.TestCheckResourceAttr(
						"hpe_morpheus_form.example",
					...
					resource.TestCheckResourceAttr("hpe_morpheus_form.example", "option_type.0.field_label", "Server"),
					resource.TestCheckResourceAttr("hpe_morpheus_form.example", "option_type.0.field_name", "server"),
					resource.TestCheckResourceAttr(
						"hpe_morpheus_form.example",
