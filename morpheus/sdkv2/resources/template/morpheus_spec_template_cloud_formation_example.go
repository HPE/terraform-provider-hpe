...
//go:generate ../../../../../bin/render -out examples/resources/morpheus_spec_template_cloud_formation/resource_git.tf morpheus_spec_template_cloud_formation_resource_git.tf.tmpl Name tf-cloud-formation-spec-example-git SourceType repository RepositoryId 2 VersionRef main SpecPath ./spec.yaml CapabilityIam true CapabilityNamedIam true CapabilityAutoExpand true
//go:generate ../../../../../bin/render -out examples/resources/morpheus_spec_template_cloud_formation/resource_local.tf morpheus_spec_template_cloud_formation_resource_local.tf.tmpl Name tf_cloud_formation_spec_example_local SourceType local SpecContent "{\n  \"AWSTemplateFormatVersion\" : \"2010-09-09\",\n  \"Description\" : \"AWS CloudFormation Sample Template S3_Website_Bucket_With_Retain_On_Delete: Sample template showing how to create a publicly accessible S3 bucket configured for website access with a deletion policy of retain on delete. **WARNING** This template creates an S3 bucket that will NOT be deleted when the stack is deleted. You will be billed for the AWS resources used if you create a stack from this template.\",\n  \"Resources\" : {\n    \"S3Bucket\" : {\n      \"Type\" : \"AWS::S3::Bucket\",\n      \"Properties\" : {\n        \"AccessControl\" : \"PublicRead\",\n        \"WebsiteConfiguration\" : {\n          \"IndexDocument\" : \"index.html\",\n          \"ErrorDocument\" : \"error.html\"\n         }\n      },\n      \"DeletionPolicy\" : \"Retain\"\n    }\n  },\n\n  \"Outputs\" : {\n    \"WebsiteURL\" : {\n      \"Value\" : { \"Fn::GetAtt\" : [ \"S3Bucket\", \"WebsiteURL\" ] },\n      \"Description\" : \"URL for website hosted on S3\"\n    },\n    \"S3BucketSecureURL\" : {\n      \"Value\" : { \"Fn::Join\" : [ \"\", [ \"https://\", { \"Fn::GetAtt\" : [ \"S3Bucket\", \"DomainName\" ] } ] ] },\n      \"Description\" : \"Name of S3 bucket to hold website content\"\n    }\n  }\n}" CapabilityIam true CapabilityNamedIam true CapabilityAutoExpand true
//go:generate ../../../../../bin/render -out examples/resources/morpheus_spec_template_cloud_formation/resource_url.tf morpheus_spec_template_cloud_formation_resource_url.tf.tmpl Name tf_cloud_formation_spec_example_url SourceType url SpecPath http://example.com/spec.yaml CapabilityIam true CapabilityNamedIam true CapabilityAutoExpand true
