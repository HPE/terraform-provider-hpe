...
func RenderTaskLibraryTemplateConfig(t *testing.T, overrides map[string]string) (string, error) {
	t.Helper()
	...
	templatePath := filepath.Join(dir, "task_library_template_resource.tf.tmpl")
