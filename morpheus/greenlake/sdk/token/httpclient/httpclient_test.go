...
import (
	...
	"github.com/HPE/terraform-provider-hpe/morpheus/greenlake/sdk/token/identitytoken"
	"github.com/HPE/terraform-provider-hpe/morpheus/greenlake/sdk/token/issuertoken"
)
...
func TestGenerateToken(t *testing.T) {
	...
	for _, testcase := range issuertokentc {
		...
		token, err := c.GenerateToken(tc.ctx, "", "", "", string(iamversion.GLCS))
		if tc.err != nil {
