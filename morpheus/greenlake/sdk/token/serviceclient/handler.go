...
import (
	...
	"github.com/HPE/terraform-provider-hpe/morpheus/greenlake/sdk/token/common"
	httpc "github.com/HPE/terraform-provider-hpe/morpheus/greenlake/sdk/token/httpclient"
...
//go:generate go run github.com/golang/mock/mockgen -build_flags=-mod=mod -destination=../mocks/IdentityAPI_mocks.go -package=mocks github.com/HPE/terraform-provider-hpe/morpheus/greenlake/sdk/token/serviceclient IdentityAPI
