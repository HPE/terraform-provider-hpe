...
// Package connected implements the GreenLake Connected token exchange. It
// trades GreenLake API client credentials for the URL and access token of the
// Morpheus instance sitting behind the VMaaS broker.
package connected
...
// Config is the GreenLake Connected configuration needed to resolve Morpheus
