...
import (
	...
	consts "github.com/HPE/terraform-provider-hpe/morpheus/greenlake/connected/sdk/vmaascmp/common"
...
// greenlake_connected token exchange configures the broker client.
