...
func schemaElementType(t *testing.T, ctx context.Context) attr.Type {
	...
	a, ok := CloudAffinityGroupsDataSourceSchema(ctx).Attributes["affinity_groups"]
	if !ok {
...
func affinityGroupFixtures() map[string]*sdk.ListCloudAffinityGroups200ResponseAllOfAffinityGroupsInner {
	minimal := &sdk.ListCloudAffinityGroups200ResponseAllOfAffinityGroupsInner{
		Id:   sdk.PtrInt64(1),
		Name: sdk.PtrString("minimal"),
	}

	full := &sdk.ListCloudAffinityGroups200ResponseAllOfAffinityGroupsInner{
		Id:           sdk.PtrInt64(2),
		Name:         sdk.PtrString("full"),
		AffinityType: sdk.PtrString("KEEP_TOGETHER"),
		Source:       sdk.PtrString("morpheus"),
		RefType:      sdk.PtrString("ComputeZone"),
		RefId:        sdk.PtrInt64(3),
		Active:       sdk.PtrBool(true),
		Visibility:   sdk.PtrString("private"),
		Pool: &sdk.ListCloudAffinityGroups200ResponseAllOfAffinityGroupsInnerPool{
			Id: sdk.PtrInt64(4),
		},
		Servers: []sdk.ListCloudAffinityGroups200ResponseAllOfAffinityGroupsInnerServersInner{
			{Id: sdk.PtrInt64(5)},
		},
		Tenants: []sdk.ListCloudAffinityGroups200ResponseAllOfAffinityGroupsInnerTenantsInner{
			{Id: sdk.PtrInt64(6)},
		},
		ResourcePermissions: &sdk.ListCloudAffinityGroups200ResponseAllOfAffinityGroupsInnerResourcePermissions{
			All: sdk.PtrBool(false),
			Sites: []map[string]interface{}{
				{"id": float64(7), "default": true},
			},
		},
	}

	return map[string]*sdk.ListCloudAffinityGroups200ResponseAllOfAffinityGroupsInner{
		"minimal": minimal,
		"full":    full,
	}
}
