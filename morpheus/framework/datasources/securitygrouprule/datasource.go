...
func ruleAsState(
	...
	return SecurityGroupRuleModel{
		...
		Name:            convert.StrToType(rule.Name.Get()),
		...
		PortRange:       convert.StrToType(rule.PortRange.Get()),
		Source:          convert.StrToType(rule.Source.Get()),
		SourceType:      convert.StrToType(rule.SourceType),
		Destination:     convert.StrToType(rule.Destination.Get()),
