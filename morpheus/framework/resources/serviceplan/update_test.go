		...
		Steps: []resource.TestStep{
			{ // create
				...
				Check: resource.ComposeTestCheckFunc(
					...
					resource.TestCheckResourceAttr("hpe_morpheus_service_plan.test", "memory_size_type", "gb"),
					...
					resource.TestCheckResourceAttr("hpe_morpheus_service_plan.test", "storage_size_type", "mb"),
