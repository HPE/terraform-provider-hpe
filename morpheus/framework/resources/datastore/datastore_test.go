...
//go:generate ../../../../bin/render example_alletramp_bm.tf.tmpl Name "TestAlletraDatastore" CloudName "Metal" AssociatedResourceID 1 StorageServerID 1 GroupID 1 TenantID 1 ResourcePoolID 1
