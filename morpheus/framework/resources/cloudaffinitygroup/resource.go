...
func (r *cloudAffinityGroupResource) Read(
	...
	if err := errfmt.CheckResponse(err, httpResp); err != nil {
		errfmt.DiagError(
			&resp.Diagnostics, errfmt.OpRead, "cloud_affinity_group", "", err, httpResp,
		)
...
func (r *cloudAffinityGroupResource) Delete(
	ctx context.Context,
	...
	_, httpResp, err := client.CloudsAPI.DeleteCloudAffinityGroup(ctx, cloudID, id).Execute()
	if err := errfmt.CheckResponse(err, httpResp); err != nil {
		errfmt.DiagError(
			&resp.Diagnostics, errfmt.OpDelete, "cloud_affinity_group", "", err, httpResp,
		)
