...
func TestAccMorpheusMonitoringGroupResourceExampleOk(t *testing.T) {
	...
	resourceConfig, err := monitoringgroup.RenderMonitoringGroupConfig(t, map[string]string{
		"Name": name,
	})
	if err != nil {
		t.Fatal(err)
...
func TestAccMorpheusMonitoringGroupResourceUpdateOk(t *testing.T) {
	...
	createConfig, err := monitoringgroup.RenderMonitoringGroupConfig(t, map[string]string{
		"Name": name,
	})
	if err != nil {
		t.Fatal(err)
