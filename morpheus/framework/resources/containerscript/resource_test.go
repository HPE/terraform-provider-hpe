...
func TestAccMorpheusContainerScriptResourceExampleOk(t *testing.T) {
	...
	resourceConfig, err := containerscript.RenderContainerScriptConfig(t, map[string]string{
		"Name": name,
	})
	if err != nil {
		t.Fatal(err)
...
func TestAccMorpheusContainerScriptResourceUpdateOk(t *testing.T) {
	...
	createConfig, err := containerscript.RenderContainerScriptConfig(t, map[string]string{
		"Name": name,
	})
	if err != nil {
		t.Fatal(err)
