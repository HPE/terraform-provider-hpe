...
var (
	_ resource.Resource                = &containerScriptResource{}
...
func NewResource() resource.Resource {
	return &containerScriptResource{}
}

func (r *containerScriptResource) Metadata(
	_ context.Context,
	req resource.MetadataRequest,
	resp *resource.MetadataResponse,
) {
	resp.TypeName = req.ProviderTypeName + "_container_script"
}
...
func (r *containerScriptResource) Create(
	...
	if !plan.ScriptVersion.IsNull() && !plan.ScriptVersion.IsUnknown() {
		body.ScriptVersion = plan.ScriptVersion.ValueStringPointer()
	}
	if !plan.ScriptPhase.IsNull() && !plan.ScriptPhase.IsUnknown() {
	...
	if !plan.RunAsUser.IsNull() && !plan.RunAsUser.IsUnknown() {
	...
	if err := errfmt.CheckResponse(err, httpResp); err != nil {
		errfmt.DiagError(&resp.Diagnostics, errfmt.OpCreate, "container_script",
...
func (r *containerScriptResource) Read(
	ctx context.Context,
	...
	if err := readScriptIntoModel(ctx, client, id, &state, &resp.Diagnostics); err != nil {
		...
		errfmt.DiagError(&resp.Diagnostics, errfmt.OpRead, "container_script", "", err, nil)
...
func (r *containerScriptResource) Update(
	...
	if err := errfmt.CheckResponse(err, httpResp); err != nil {
		errfmt.DiagError(&resp.Diagnostics, errfmt.OpUpdate, "container_script",
			plan.Name.ValueString(), err, httpResp)
...
func (r *containerScriptResource) Delete(
	ctx context.Context,
	...
	if err := errfmt.CheckResponse(err, httpResp); err != nil {
		errfmt.DiagError(&resp.Diagnostics, errfmt.OpDelete, "container_script", "", err, httpResp)

		return
	}
}

func (r *containerScriptResource) ImportState(
	ctx context.Context,
