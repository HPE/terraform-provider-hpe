...
func TestAccMorpheusClusterNamespaceResourceUpdateOk(t *testing.T) {
	...
	createConfig, err := clusternamespace.RenderClusterNamespaceConfig(t, map[string]string{
		"ClusterId": clusterID,
		"Name":      name,
	})
	if err != nil {
	...
	updateConfig, err := clusternamespace.RenderClusterNamespaceConfig(t, map[string]string{
		"ClusterId": clusterID,
		"Name":      updatedName,
	})
	if err != nil {
