...
func TestAccMorpheusProvisioningLicenseResourceExampleOk(t *testing.T) {
	...
	resourceConfig, err := provisioninglicense.RenderProvisioningLicenseConfig(t, map[string]string{
		"Name": name,
	})
	if err != nil {
		t.Fatal(err)
...
func TestAccMorpheusProvisioningLicenseResourceUpdateOk(t *testing.T) {
	...
	createConfig, err := provisioninglicense.RenderProvisioningLicenseConfig(t, map[string]string{
		"Name": name,
	})
	if err != nil {
		t.Fatal(err)
	...
	updateConfig, err := provisioninglicense.RenderProvisioningLicenseConfig(t, map[string]string{
		"Name":         name,
