...
//go:generate ../../../../bin/render -out examples/resources/morpheus_network_router_firewall_rule_group/example.tf example.tf.tmpl RouterId "1" Name "Example Firewall Rule Group" GroupLayer "LocalGatewayRules"
