...
func TestAccMorpheusPowerScheduleResourceExampleOk(t *testing.T) {
	...
	resourceConfig, err := powerschedule.RenderPowerScheduleConfig(t, map[string]string{
		"Name": name,
	})
	if err != nil {
		t.Fatal(err)
...
func TestAccMorpheusPowerScheduleResourceUpdateOk(t *testing.T) {
	...
	createConfig, err := powerschedule.RenderPowerScheduleConfig(t, map[string]string{
		"Name": name,
	})
	if err != nil {
		t.Fatal(err)
