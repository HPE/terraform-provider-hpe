...
func TestAccMorpheusVdiGatewayResourceExampleOk(t *testing.T) {
	...
	resourceConfig, err := vdigateway.RenderVdiGatewayConfig(t, map[string]string{
		"Name": name,
	})
	if err != nil {
		t.Fatal(err)
...
func TestAccMorpheusVdiGatewayResourceUpdateOk(t *testing.T) {
	...
	createConfig, err := vdigateway.RenderVdiGatewayConfig(t, map[string]string{
		"Name": name,
	})
	if err != nil {
		t.Fatal(err)
	...
	updateConfig, err := vdigateway.RenderVdiGatewayConfig(t, map[string]string{
		"Name":        name,
