...
func TestAccMorpheusMonitoringAlertResourceExampleOk(t *testing.T) {
	...
	resourceConfig, err := monitoringalert.RenderMonitoringAlertConfig(t, map[string]string{
		"Name": name,
	})
	if err != nil {
		t.Fatal(err)
...
func TestAccMorpheusMonitoringAlertResourceUpdateOk(t *testing.T) {
	...
	createConfig, err := monitoringalert.RenderMonitoringAlertConfig(t, map[string]string{
		"Name": name,
	})
	if err != nil {
		t.Fatal(err)
