...
const sweeperName = "hpe_morpheus_backup_instance"
...
func init() {
	testsweep.RegisterTypedAPISweeper(
		...
		// Is this a test instance backup?
		func(item sdk.ListBackups200ResponseAllOfBackupsInner) bool {
			if item.LocationType == nil || *item.LocationType != "instance" {
				return false
			}
		...
		// Delete the test instance backup.
		func(
			ctx context.Context,
