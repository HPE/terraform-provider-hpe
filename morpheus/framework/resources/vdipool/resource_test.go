...
func TestAccMorpheusVdiPoolResourceExampleOk(t *testing.T) {
	...
	resourceConfig, err := vdipool.RenderVdiPoolConfig(t, map[string]string{
		"Name": name,
	})
	if err != nil {
		t.Fatal(err)
...
func TestAccMorpheusVdiPoolResourceUpdateOk(t *testing.T) {
	...
	createConfig, err := vdipool.RenderVdiPoolConfig(t, map[string]string{
		"Name": name,
	})
	if err != nil {
		t.Fatal(err)
	...
	updateConfig, err := vdipool.RenderVdiPoolConfig(t, map[string]string{
		"Name":        name,
