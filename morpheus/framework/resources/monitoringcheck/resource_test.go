...
func TestAccMorpheusMonitoringCheckResourceExampleOk(t *testing.T) {
	...
	resourceConfig, err := monitoringcheck.RenderMonitoringCheckConfig(t, map[string]string{
		"Name": name,
	})
	if err != nil {
		t.Fatal(err)
...
func TestAccMorpheusMonitoringCheckResourceUpdateOk(t *testing.T) {
	...
	createConfig, err := monitoringcheck.RenderMonitoringCheckConfig(t, map[string]string{
		"Name": name,
	})
	if err != nil {
		t.Fatal(err)
