...
`
	...
	resourceConfig, err := securitygrouprule.RenderSecurityGroupRuleConfig(t, map[string]string{
...
`
	...
	createConfig, err := securitygrouprule.RenderSecurityGroupRuleConfig(t, map[string]string{
		"SecurityGroupId": "hpe_morpheus_security_group.test.id",
		"Name":            name + "-rule",
	})
	if err != nil {
	...
	updateConfig, err := securitygrouprule.RenderSecurityGroupRuleConfig(t, map[string]string{
		"SecurityGroupId": "hpe_morpheus_security_group.test.id",
		"Name":            name + "-rule",
		"Protocol":        "udp",
		"PortRange":       "53",
