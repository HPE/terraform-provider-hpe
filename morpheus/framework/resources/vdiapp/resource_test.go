...
func TestAccMorpheusVdiAppResourceExampleOk(t *testing.T) {
	...
	resourceConfig, err := vdiapp.RenderVdiAppConfig(t, map[string]string{
		"Name": name,
	})
	if err != nil {
		t.Fatal(err)
...
func TestAccMorpheusVdiAppResourceUpdateOk(t *testing.T) {
	...
	createConfig, err := vdiapp.RenderVdiAppConfig(t, map[string]string{
		"Name": name,
	})
	if err != nil {
		t.Fatal(err)
	...
	updateConfig, err := vdiapp.RenderVdiAppConfig(t, map[string]string{
		"Name":         name,
		"Description":  "Updated",
