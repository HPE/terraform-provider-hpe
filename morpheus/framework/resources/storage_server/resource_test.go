...
func TestAccMorpheusStorageServerResourceExampleOk(t *testing.T) {
	...
	resourceConfig, err := storage_server.RenderStorageServerConfig(t, map[string]string{
		"Name": name,
	})
	if err != nil {
		t.Fatal(err)
...
func TestAccMorpheusStorageServerResourceUpdateOk(t *testing.T) {
	...
	createConfig, err := storage_server.RenderStorageServerConfig(t, map[string]string{
		"Name": name,
	})
	if err != nil {
		t.Fatal(err)
	...
	updateConfig, err := storage_server.RenderStorageServerConfig(t, map[string]string{
		"Name": updatedName,
	})
	if err != nil {
		t.Fatal(err)
