...
//go:generate go run ../../../../../cmd/render data-sources/hpe_morpheus_group example-id.tf.tmpl Id 99
//go:generate go run ../../../../../cmd/render data-sources/hpe_morpheus_group example-name.tf.tmpl Name "\"Example name\""
