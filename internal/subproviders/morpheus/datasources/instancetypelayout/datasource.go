...
//go:generate go run ../../../../../cmd/render data-sources/hpe_morpheus_instance_type_layout example-id.tf.tmpl Id 99
//go:generate go run ../../../../../cmd/render data-sources/hpe_morpheus_instance_type_layout example-name.tf.tmpl Name "Example name"
//go:generate go run ../../../../../cmd/render data-sources/hpe_morpheus_instance_type_layout example-name-version.tf.tmpl Name "Example name" Version "1.2.3"
