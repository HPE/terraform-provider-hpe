...
// checks if the DatastoreTypesOptionTypesInner type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &DatastoreTypesOptionTypesInner{}

// DatastoreTypesOptionTypesInner struct for DatastoreTypesOptionTypesInner
type DatastoreTypesOptionTypesInner struct {
	...
	OptionList            *DatastoreTypesOptionTypesInnerOptionList `json:"optionList,omitempty"`
...
type _DatastoreTypesOptionTypesInner DatastoreTypesOptionTypesInner

func (o DatastoreTypesOptionTypesInner) MarshalJSON() ([]byte, error) {
...
func (o DatastoreTypesOptionTypesInner) ToMap() (map[string]interface{}, error) {
...
type NullableDatastoreTypesOptionTypesInner struct {
	value *DatastoreTypesOptionTypesInner
	isSet bool
}

func (v NullableDatastoreTypesOptionTypesInner) Get() *DatastoreTypesOptionTypesInner {
	return v.value
}

func (v *NullableDatastoreTypesOptionTypesInner) Set(val *DatastoreTypesOptionTypesInner) {
	v.value = val
	v.isSet = true
}

func (v NullableDatastoreTypesOptionTypesInner) IsSet() bool {
	return v.isSet
}

func (v *NullableDatastoreTypesOptionTypesInner) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableDatastoreTypesOptionTypesInner(val *DatastoreTypesOptionTypesInner) *NullableDatastoreTypesOptionTypesInner {
	return &NullableDatastoreTypesOptionTypesInner{value: val, isSet: true}
}

func (v NullableDatastoreTypesOptionTypesInner) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableDatastoreTypesOptionTypesInner) UnmarshalJSON(src []byte) error {
	v.isSet = true
	return json.Unmarshal(src, &v.value)
}

func (v NullableDatastoreTypesOptionTypesInner) UnmarshalMapstructure(data any) (any, error) {
...
func (o *DatastoreTypesOptionTypesInner) UnmarshalJSON(data []byte) (err error) {
