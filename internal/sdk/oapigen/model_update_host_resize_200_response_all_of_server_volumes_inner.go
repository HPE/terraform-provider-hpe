...
type UpdateHostResize200ResponseAllOfServerVolumesInner struct {
	...
	StorageGroup         *UpdateHostResize200ResponseAllOfServerVolumesInnerStorageGroup  `json:"storageGroup,omitempty"`
	Namespace            NullableString                                                   `json:"namespace,omitempty"`
	StorageServer        *UpdateHostResize200ResponseAllOfServerVolumesInnerStorageServer `json:"storageServer,omitempty"`
