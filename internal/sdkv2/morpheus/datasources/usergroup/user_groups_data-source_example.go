...
//go:generate sh -c " ../../../../../bin/render -out examples/data-sources/morpheus_user_groups/data-source.tf user_groups_data-source.tf.tmpl Name '\"name\"' SortAscending 'true' Values '[\".*\"]'"
