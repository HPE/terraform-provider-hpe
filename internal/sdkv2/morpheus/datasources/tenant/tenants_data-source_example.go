...
//go:generate sh -c "go run ../../../../../cmd/render -out examples/data-sources/morpheus_tenants/data-source.tf tenants_data-source.tf.tmpl Name 'name' SortAscending 'true' Values '\".*\"'"
