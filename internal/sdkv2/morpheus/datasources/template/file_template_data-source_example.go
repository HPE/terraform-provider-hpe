...
//go:generate sh -c "go run ../../../../../cmd/render -out examples/data-sources/morpheus_file_template/data-source.tf file_template_data-source.tf.tmpl Name '\"Terraform Example File Template\"'"
