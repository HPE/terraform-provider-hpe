...
import (
	...
	dscosting "github.com/HPE/terraform-provider-hpe/internal/sdkv2/morpheus/datasources/costing"
)
...
func TestAccMorpheusDataSourceBudgetExampleOk(t *testing.T) {
	t.Parallel()
	...
	datasourceConfig, err := dscosting.RenderBudgetConfig(t, map[string]string{
		"Name": name,
	})
	if err != nil {
		t.Fatal(err)
