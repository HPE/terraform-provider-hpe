...
//go:generate sh -c "go run ../../../../../cmd/render -out examples/data-sources/morpheus_node_type/data-source.tf node_type_data-source.tf.tmpl Name '\"TF Example node type\"'"
