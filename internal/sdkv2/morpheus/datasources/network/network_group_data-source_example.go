...
//go:generate sh -c "go run ../../../../../cmd/render -out examples/data-sources/morpheus_network_group/data-source.tf network_group_data-source.tf.tmpl Name '\"TF Example Network Group\"'"
