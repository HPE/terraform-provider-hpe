...
//go:generate sh -c "go run ../../../../../cmd/render -out examples/data-sources/morpheus_network_subnet/data-source.tf network_subnet_data-source.tf.tmpl Name '\"TF Example Network Subnet\"' NetworkId '166333'"
