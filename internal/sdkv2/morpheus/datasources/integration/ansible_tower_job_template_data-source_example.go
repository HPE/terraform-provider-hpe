...
//go:generate sh -c "go run ../../../../../cmd/render -out examples/data-sources/morpheus_ansible_tower_job_template/data-source.tf ansible_tower_job_template_data-source.tf.tmpl Name '\"Demo Job Template\"'"
