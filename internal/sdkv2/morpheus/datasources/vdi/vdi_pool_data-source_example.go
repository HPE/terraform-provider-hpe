...
//go:generate sh -c "go run ../../../../../cmd/render -out examples/data-sources/morpheus_vdi_pool/data-source.tf vdi_pool_data-source.tf.tmpl Name '\"Terraform Example VDI Pool\"'"
