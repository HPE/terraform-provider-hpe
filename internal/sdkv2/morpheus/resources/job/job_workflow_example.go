...
//go:generate go run ../../../../../cmd/render -out examples/resources/morpheus_job_workflow/resource_date_and_time.tf job_workflow_date_and_time.tf.tmpl Name "TF Example Workflow Job Date and Time" Enabled true Labels "[\"aws\", \"demo\"]" WorkflowId 1 ScheduleMode date_and_time ScheduledDateAndTime 2022-12-30T06:00:00Z ContextType instance InstanceIds "[1, 2]" CustomOptions "{\"demo\" = \"testing\"}"

//go:generate go run ../../../../../cmd/render -out examples/resources/morpheus_job_workflow/resource_schedule.tf job_workflow_schedule.tf.tmpl Name "TF Example Workflow Job Schedule" Enabled true Labels "[\"aws\", \"demo\"]" WorkflowId 1 ScheduleMode scheduled ExecutionScheduleId 1 ContextType instance InstanceIds "[91]" CustomOptions "{\"demo\" = \"testing\"}"

//go:generate go run ../../../../../cmd/render -out examples/resources/morpheus_job_workflow/resource_manual.tf job_workflow_manual.tf.tmpl Name "TF Example Workflow Job Manual" Enabled true Labels "[\"aws\", \"demo\"]" WorkflowId 1 ScheduleMode manual ContextType instance-label InstanceLabel demo CustomOptions "{\"demo\" = \"testing\"}"
