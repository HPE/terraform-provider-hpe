...
func RenderMorpheusOptionTypePasswordConfig(t *testing.T, overrides map[string]string) (string, error) {
	...
	return testhelpers.RenderExample(t, "morpheus_option_type_password_resource.tf.tmpl",
		"Name", defaults["Name"],
...
func TestAccMorpheusOptionTypePasswordExampleOk(t *testing.T) {
	...
	resourceConfig, err := RenderMorpheusOptionTypePasswordConfig(t, map[string]string{"Name": name})
	if err != nil {
		t.Fatal(err)
	}
