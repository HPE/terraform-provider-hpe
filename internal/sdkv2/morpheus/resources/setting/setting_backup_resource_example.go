...
//go:generate sh -c "go run ../../../../../cmd/render -out examples/resources/morpheus_setting_backup/resource.tf setting_backup_resource.tf.tmpl BackupAppliance 'false' CreateBackups 'true' DefaultBackupScheduleId '3' DefaultBackupStorageBucketId '17' RetentionDays '21' ScheduledBackups 'true'"
