...
//go:generate sh -c "go run ../../../../../cmd/render -out examples/resources/morpheus_spec_template_helm/resource_local.tf spec_template_helm_resource_local.tf.tmpl Name 'tf-helm-spec-example-local' SourceType 'local' SpecContent '<<TFEOF\napiVersion: v1\nkind: Service\nmetadata:\nname: {{ template \"fullname\" . }}\nlabels:\n chart: \"{{ .Chart.Name }}-{{ .Chart.Version | replace \"+\" \"_\" }}\"\nspec:\ntype: {{ .Values.service.type }}\nports:\n- port: {{ .Values.service.externalPort }}\n targetPort: {{ .Values.service.internalPort }}\n protocol: TCP\n name: {{ .Values.service.name }}\nselector:\n app: {{ template \"fullname\" . }}\nTFEOF'"
