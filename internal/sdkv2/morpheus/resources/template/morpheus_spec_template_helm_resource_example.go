...
//go:generate go run ../../../../../cmd/render -out examples/resources/morpheus_spec_template_helm/resource_url.tf morpheus_spec_template_helm_resource_url.tf.tmpl Name tf-helm-spec-example-url SourceType url SpecPath http://example.com/chart.yaml
