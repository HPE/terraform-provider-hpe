...
//go:generate go run ../../../../../cmd/render -out examples/resources/app_blueprint_cloud_formation/app_blueprint_cloud_formation_resource_git.tf app_blueprint_cloud_formation_resource_git.tf.tmpl CapabilityAutoExpand "true" CapabilityIam "true" CapabilityNamedIam "true" Category "cloudformation" CloudInitEnabled "true" Description "Example cloud formation app blueprint" InstallAgent "true" IntegrationId "3" Name "example_cloud_formation_app_blueprint_git" RepositoryId "1" SourceType "repository" VersionRef "main" WorkingPath "./test"

// RenderAppBlueprintCloudFormationGitConfig generates a Terraform configuration
// for the app blueprint cloud formation git resource.
