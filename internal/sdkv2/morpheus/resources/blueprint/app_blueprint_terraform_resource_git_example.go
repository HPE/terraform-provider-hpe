...
func RenderAppBlueprintTerraformGitConfig(t *testing.T, overrides map[string]string) (string, error) {
	...
	templatePath := filepath.Join(dir, "app_blueprint_terraform_resource_git.tf.tmpl")
