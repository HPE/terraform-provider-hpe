...
//go:generate go run ../../../../../cmd/render -out examples/resources/app_blueprint_cloud_formation/app_blueprint_cloud_formation_resource_json.tf app_blueprint_cloud_formation_resource_json.tf.tmpl CapabilityAutoExpand "true" CapabilityIam "true" CapabilityNamedIam "true" Category "cloudformation" CloudInitEnabled "true" Description "Example cloud formation app blueprint" InstallAgent "true" Name "example_cloud_formation_app_blueprint_json" SourceType "json" BlueprintContent "..."

// RenderAppBlueprintCloudFormationJSONConfig generates a Terraform configuration
// for the app blueprint cloud formation json resource.
