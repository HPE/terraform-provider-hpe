...
//go:generate sh -c "go run ../../../../../cmd/render -out examples/resources/morpheus_app_blueprint_terraform/resource_json.tf app_blueprint_terraform_resource_json.tf.tmpl BlueprintContent '{\"test\":\"demo123\"}' Category 'terraformdemo' Description 'testing terraform' Name 'tfappbluedemojson' SourceType 'json' TerraformOptions '-var foo=bar' TerraformVersion '1.1.1' TfvarSecret 'tfvars/rdsdemo-secrets'"
