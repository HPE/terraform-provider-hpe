...
//go:generate sh -c "go run ../../../../../cmd/render -out examples/resources/morpheus_app_blueprint_helm/resource.tf app_blueprint_helm_resource.tf.tmpl Category 'helm' Description 'tf example helm app blueprint' IntegrationId '3' Name 'helmappblueprint' RepositoryId '1' VersionRef 'main' WorkingPath './test'"
