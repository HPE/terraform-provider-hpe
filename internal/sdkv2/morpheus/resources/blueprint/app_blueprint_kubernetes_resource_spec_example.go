...
//go:generate sh -c "go run ../../../../../cmd/render -out examples/resources/morpheus_app_blueprint_kubernetes/resource_spec.tf app_blueprint_kubernetes_resource_spec.tf.tmpl Category 'k8s' Description 'tf example kubernetes app blueprint' Name 'tf-kubernetes-app-blueprint-example-spec' SourceType 'spec' SpecTemplateIds '[2, 3]'"
