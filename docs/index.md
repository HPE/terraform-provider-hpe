...
->This v1.0.0 release incorporates all the functionality of the [Morpheus Terraform Provider](https://registry.terraform.io/providers/gomorpheus/morpheus/latest).
This provider can now be used instead of the Morpheus provider.  Users are encouraged to start using this provider in preference to
the Morpheus provider, which will be deprecated in the future.<br><br>
See below for the mapping of Morpheus provider resources and data-sources to those in this provider.
...
`hpe` Morpheus resources and data sources.
