...
- hpe_morpheus_instance for HPE HVM or HPE VME instances (Create, Read and Delete - no Update)
- hpe_morpheus_group for Morpheus groups
...
- hpe_morpheus_service_plan (Create, Read and Delete - no Update)
