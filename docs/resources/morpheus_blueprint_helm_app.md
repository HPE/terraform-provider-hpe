---
page_title: "hpe_morpheus_blueprint_helm_app Resource - terraform-provider-hpe"
subcategory: "morpheus"
description: |-
  Provides a Morpheus helm app blueprint resource
---
# hpe_morpheus_blueprint_helm_app (Resource)
...
```shell
terraform import hpe_morpheus_blueprint_helm_app.tf_example_helm_app_blueprint 1
```
