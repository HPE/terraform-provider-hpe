...
- `compute_servers` (Set of Number) The IDs of the compute servers backing this instance. An instance has
...
- `affinity_group_id` (Number) The affinity group to place the instance into at provision time.
