---
page_title: "hpe_morpheus_blueprint_arm_app Resource - terraform-provider-hpe"
subcategory: "morpheus"
description: |-
  Provides a Morpheus arm app blueprint resource
---
# hpe_morpheus_blueprint_arm_app (Resource)
...
```shell
terraform import hpe_morpheus_blueprint_arm_app.tf_example_arm_app_blueprint 1
```
