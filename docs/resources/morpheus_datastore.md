...
Note that when importing a datastore the `resource_permissions` and `tenants` will not be populated.  You will need to perform an update
to the imported datastore to set these attributes.
