---
page_title: "hpe_morpheus_blueprint_kubernetes_app Resource - terraform-provider-hpe"
subcategory: "morpheus"
description: |-
  Provides a Morpheus kubernetes app blueprint resource
---
# hpe_morpheus_blueprint_kubernetes_app (Resource)
...
```shell
terraform import hpe_morpheus_blueprint_kubernetes_app.tf_example_kubernetes_app_blueprint 1
```
