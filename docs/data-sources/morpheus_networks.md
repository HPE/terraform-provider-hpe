...
---
# hpe_morpheus_networks (Data Source)
...
- `name` (String) The name of the filter. Valid names are (name)
- `values` (Set of String) The filter values. Filters support Golang regex and can be tested at https://regex101.com/