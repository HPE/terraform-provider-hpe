			...
			Steps: []resource.TestStep{
				{
					...
					Check: resource.ComposeAggregateTestCheckFunc(
						...
						resource.TestCheckResourceAttr("hpe_opsramp_scheduled_maintenance.test", "description", "Initial maintenance window"),
						resource.TestCheckResourceAttr("hpe_opsramp_scheduled_maintenance.test", "schedule.type", "one-time"),
						resource.TestCheckResourceAttr("hpe_opsramp_scheduled_maintenance.test", "schedule.timezone", "Europe/Paris"),
				...
				},
				{
					...
					Check: resource.ComposeAggregateTestCheckFunc(
						...
						resource.TestCheckResourceAttr("hpe_opsramp_scheduled_maintenance.test", "description", "Updated maintenance window"),
					),
				},
				// ImportState testing
				{
			...
			Steps: []resource.TestStep{
				{
					...
					Check: resource.ComposeAggregateTestCheckFunc(
						...
						resource.TestCheckResourceAttr("hpe_opsramp_scheduled_maintenance.test_recurring", "schedule.type", "recurring"),
						resource.TestCheckResourceAttr("hpe_opsramp_scheduled_maintenance.test_recurring", "schedule.timezone", "Europe/Paris"),
						resource.TestCheckResourceAttr("hpe_opsramp_scheduled_maintenance.test_recurring", "schedule.pattern.type", "weekly"),
						resource.TestCheckResourceAttr("hpe_opsramp_scheduled_maintenance.test_recurring", "schedule.pattern.week_days", "Monday,Wednesday,Friday"),
						resource.TestCheckResourceAttr("hpe_opsramp_scheduled_maintenance.test_recurring", "schedule.end_by", "Never"),
					),
				},
			},
		})
			...
			Steps: []resource.TestStep{
				{
					...
					Check: resource.ComposeAggregateTestCheckFunc(
						...
						resource.TestCheckResourceAttr("hpe_opsramp_scheduled_maintenance.test_alerts", "alert_conditions.matching_type", "ANY"),
						resource.TestCheckResourceAttr("hpe_opsramp_scheduled_maintenance.test_alerts", "alert_conditions.rules.0.key", "subject"),
						resource.TestCheckResourceAttr("hpe_opsramp_scheduled_maintenance.test_alerts", "alert_conditions.rules.0.operator", "contains"),
						resource.TestCheckResourceAttr("hpe_opsramp_scheduled_maintenance.test_alerts", "alert_conditions.rules.0.value", "maintenance"),
					),
				},
			},
		})
